...
import 'package:cadastros_bd/widgets/text_field_widget.dart';
...
class ProductFormPage extends StatefulWidget {
  ...
  const ProductFormPage({super.key, this.produto, this.onsave});
...
class _ProductFormPageState extends State<ProductFormPage> {
  ...
  void initState() {
    ...
    if (widget.produto != null) {
      _productNameController.text = widget.produto!.nome;
      _productPurchasePriceController.updateValue(widget.produto!.precoCompra);
      _productSalePriceController.updateValue(widget.produto!.precoVenda);
      _productQuantityController.updateValue(
        widget.produto!.quantidade.toDouble(),
      );
      _productDescriptionController.text = widget.produto!.descricao;
      _productImageController.text = widget.produto!.imagem ?? '';
      _productActive = widget.produto!.ativo;
      _productCategory = widget.produto!.categoria;
      _productOnSale = widget.produto!.emPromocao;
      _discountValue = widget.produto!.desconto;
    }
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(
          widget.produto != null ? 'Editar Produto' : 'Cadastrar Produto',
        ...
        child: Column(
          ...
          children: [
            ...
            ElevatedButton.icon(
              ...
              label: Text(
                widget.produto != null ? 'Alterar Produto' : 'Cadastrar Produto',
                style: const TextStyle(color: Colors.white),
              ),
